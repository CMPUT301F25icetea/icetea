 ...
 * - totalParticipants: int (max number of participants) - DEPRECATED, use capacity
...
public class Event {
    ...
    private Integer capacity;  // ADDED: Firestore uses 'capacity' field
    ...
    public Event(String id, String name, String description, int totalParticipants,
        ...
        this.capacity = totalParticipants;  // ADDED: Set capacity same as totalParticipants
    ...
    // ADDED: Capacity getter and setter
    ...
    public boolean isWaitlistFull() {
        // UPDATED: Use capacity if available, otherwise fall back to totalParticipants
        int maxCapacity = (capacity > 0) ? capacity : totalParticipants;
    ...
    public String validate() {
        ...
        // UPDATED: Check capacity first, then totalParticipants
        int maxCapacity = (capacity > 0) ? capacity : totalParticipants;
        if (maxCapacity <= 0) {
            return "Event capacity must be greater than 0";
        }
