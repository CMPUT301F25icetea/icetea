...
public class SignUpFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        backButton = view.findViewById(R.id.buttonSignInBack);
        emailEditText = view.findViewById(R.id.signUpEmailAddress);
        ...
        signUpButton.setOnClickListener(v -> {
            ...
            FBAuthenticator.signUpUser(email, password, new OnCompleteListener<AuthResult>() {
                @Override
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful() && getActivity() != null) {
                        Toast.makeText(getActivity(), "Signed up as " + role, Toast.LENGTH_SHORT).show();

                        startMainActivity();
                        //add to normal db too
